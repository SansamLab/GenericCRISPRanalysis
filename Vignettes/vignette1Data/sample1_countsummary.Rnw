...
library(xtable)
filelist=c("/tmp/tmp.TA5UvcE7QJ/SRR10852434.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852437.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852440.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852435.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852438.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852441.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852443.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852447.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852450.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852436.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852439.fastq","/tmp/tmp.TA5UvcE7QJ/SRR10852442.fastq");
labellist=c("Day0","Day0","Day0","MOLM-13.DMSO_1","MOLM-13.DMSO_2","MOLM-13.DMSO_3","MOLM-13.Midostaurin_3","MOLM-13.Midostaurin_4","MOLM-13.Midostaurin_5","MOLM-13.Gilteritinib_1","MOLM-13.Gilteritinib_2","MOLM-13.Gilteritinib_3");
reads=c(40616493,40974064,47176671,42939026,48819974,47134901,60248270,51847349,36958507,46186352,46445931,45741686);
mappedreads=c(20654965,26689244,31356907,28192266,28828738,30060983,38320364,35024491,25112845,31340482,30565612,27199696);
totalsgrnas=c(77441,77441,77441,77441,77441,77441,77441,77441,77441,77441,77441,77441);
zerocounts=c(2466,1112,409,2056,2081,659,322,385,274,1157,1997,588);
giniindex=c(0.19945557393763624,0.16540017297375298,0.09845320629184029,0.21629936951436723,0.2221340913181713,0.12275091085774448,0.101263025866276,0.10189095640674162,0.08471520558758427,0.19189356505411304,0.21783275119358347,0.12350324263524293);
...
genboxplot("sample1.count_normalized.txt");
@
...
genhistplot("sample1.count_normalized.txt");
@
...
genpcaplot("sample1.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=6.5,height=6.5>>=
genclustering("sample1.count_normalized.txt");
@
