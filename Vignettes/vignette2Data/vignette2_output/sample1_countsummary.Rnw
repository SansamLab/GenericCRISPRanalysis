...
library(xtable)
filelist=c("/tmp/tmp.FahF7DEHsv/brunello_TNscreen_S32_R1_001.f astq","/tmp/tmp.FahF7DEHsv/SRR8983579.fastq","/tmp/tmp.FahF7DEHsv/SRR6737232.fastq","/tmp/tmp.FahF7DEHsv/SRR8297998.fastq");
labellist=c("Sansam_Brunello_lentiguide","SRR8983579_Brunello_lentiguide","SRR6737232_Brunello_lentiguide","SRR8297998_Brunello_lentiguide");
reads=c(38947070,53988374,28800803,60120685);
mappedreads=c(26961023,39374415,20954251,26839950);
totalsgrnas=c(77441,77441,77441,77441);
zerocounts=c(113,15,111,91);
giniindex=c(0.058222730137708956,0.053195122532483485,0.06159864107425694,0.0572995228581854);
